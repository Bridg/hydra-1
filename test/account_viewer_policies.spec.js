...
describe('The "account-viewer" role (act_1 member)', () => {
  ...
  describe('HTTP "POST"', () => {
    ...
    describe('context "/brands" (brd_1: act_1, brd_2: act_2)', () => {
      ...
      it('is NOT allowed access to "/brd_1/profile-collections"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:profile-collections', c1, false, done);
      });
  ...
  describe('HTTP "PUT"', () => {
    ...
    describe('context "/brands" (brd_1: act_1, brd_2: act_2)', () => {
      ...
      it('is NOT allowed access to "/brd_1/profile-collections/col_1"', (done) => {
        testWardenResponse('update', 'rn:bridg:accounts:act_1:brands:brd_1:profile-collections:col_1', c1, false, done);
      });
